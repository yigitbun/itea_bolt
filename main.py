...
# Load data files from the correct path
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
KB_CLEAN_PATH = os.path.join(BASE_DIR, "kbClean.csv")
GM_CLEAN_PATH = os.path.join(BASE_DIR, "GM_Clean.csv")

# klinikbewertungen.de 
df = pd.read_csv(KB_CLEAN_PATH)
...
# Google Maps
dfgm = pd.read_csv(GM_CLEAN_PATH)
